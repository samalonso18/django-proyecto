...
from Proyecto1.views import saludo, segunda_vista, tercera_vista, diaDeHoy,miNombreEs,probandoTemplate, pruebaTemplate  #Para acceder a la vista hay que importar el modulo y el método
...
urlpatterns = [
    ...
    path('pruebatemplate/',pruebaTemplate),    
